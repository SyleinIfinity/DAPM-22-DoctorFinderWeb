          ...
          <nav className="member-topbar__nav">
            {[
              ...
              <NavLink
                ...
                className={({ isActive }) =>
                  isActive
                    ? "member-topbar__item member-topbar__item--active"
                    : "member-topbar__item"
                }
            ...
            {menuOpen ? (
              <div className="member-user-menu">
                <div className="member-user-menu__header">
                  ...
                  <div className="member-user-menu__meta">
                    TK #{accountId ?? "—"}
                  </div>
                </div>
                <NavLink
                  to="/app/account"
                  className="member-user-menu__item"
                  onClick={() => setMenuOpen(false)}
                >
                  Hồ sơ tài khoản
                </NavLink>
                <button
                  className="member-user-menu__item member-user-menu__danger"
                  type="button"
