...
export function formatLongDate(value: string | null | undefined) {
  return formatDate(value, { weekday: 'long', day: '2-digit', month: 'long', year: 'numeric' })
}
...
export function DoctorPageHeading({
  ...
  return (
    <div className="doctor-page-heading">
      ...
      {actions ? <div className="doctor-page-heading__actions">{actions}</div> : null}
    </div>
  )
}
      ...
      {(title || description || aside) ? (
        <div className="doctor-panel__header">
          <div>
            ...
            {description ? <p className="doctor-panel__description">{description}</p> : null}
          </div>
