          ...
          {needsAttention && profileStatus ? (
            <DoctorNotice
              ...
              description={
                ...
                "Hãy kiểm tra và cập nhật hồ sơ để duy trì vận hành ổn định."
              }
              action={
                <Link
                  className="doctor-button doctor-button--secondary doctor-button-link"
          ...
          <section className="doctor-hero">
            <div className="doctor-hero__content">
              ...
              <h2 className="doctor-hero__title">
                Sẵn sàng tiếp nhận bệnh nhân với lịch làm việc và hồ sơ được
                quản lý rõ ràng.
              </h2>
              <p className="doctor-hero__subtitle">
                Nắm nhanh tình trạng hồ sơ, chuyên khoa phụ trách và các thao
                tác cần ưu tiên trong ngày làm việc.
              </p>
              ...
              <div className="doctor-action-grid">
                {quickActions.map((action) => (
                  <Link
                    ...
                    to={action.to}
                  >
                    <span className="doctor-action-card__tag">
                      {action.tag}
                    </span>
                    <span className="doctor-action-card__title">
                      {action.title}
                    </span>
            ...
            >
              <div className="doctor-meta-list">
                ...
                <div className="doctor-meta-item">
                  ...
                  <div className="doctor-meta-item__value">
                    {profile.moTaBanThan ||
                      "Chưa có mô tả. Bổ sung tại hồ sơ cá nhân."}
                  </div>
                </div>
              </div>
