  ...
  return (
    <div className="doctor-page">
      ...
      <section className="doctor-metrics-grid">
        ...
        <DoctorStatCard label="Số ngày đã chọn" value={String(selectedDates.length)} hint="Có thể chọn một hoặc nhiều ngày để tạo lịch hàng loạt." />
      ...
      <div className="doctor-schedule-grid">
        <DoctorPanel title="Lịch tháng" description="Ô trắng: chưa có lịch. Xanh lá: đã tạo và chưa có người đặt. Nâu: đã có người đặt. Xám nhạt: ngày đã qua.">
