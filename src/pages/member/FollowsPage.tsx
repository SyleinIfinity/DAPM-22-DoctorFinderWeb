...
export function FollowsPage() {
  ...
  const currentData =
    activeTab === "FOLLOWED" ? followedQuery.data : recentQuery.data;
  const isLoading =
    activeTab === "FOLLOWED" ? followedQuery.isLoading : recentQuery.isLoading;
  ...
  return (
    ...
    >
      ...
      <div
        className="container"
        style={{ maxWidth: "600px", margin: "0 auto", padding: "10px 20px" }}
      >
        {/* Tìm kiếm */}
        <div style={{ position: "relative", marginBottom: "20px" }}>
          ...
          <input
            ...
            placeholder={
              activeTab === "FOLLOWED"
                ? "Tìm trong danh sách theo dõi..."
                : "Tìm trong bác sĩ vừa xem..."
            }
          />
        </div>
        ...
        >
          <button
            ...
            style={{
              ...
              fontWeight: "800",
              fontSize: "15px",
              color: activeTab === "FOLLOWED" ? "#24D5DB" : "#9CA3AF",
              borderBottom:
                activeTab === "FOLLOWED" ? "3px solid #24D5DB" : "none",
              cursor: "pointer",
              transition: "0.3s",
            }}
          >
          ...
          <button
            ...
            style={{
              ...
              fontWeight: "800",
              fontSize: "15px",
              color: activeTab === "RECENT" ? "#24D5DB" : "#9CA3AF",
              borderBottom:
                activeTab === "RECENT" ? "3px solid #24D5DB" : "none",
              cursor: "pointer",
              transition: "0.3s",
            }}
          >
          ...
          {currentData?.map((f) => (
            ...
            >
              ...
              <button
                onClick={() =>
                  activeTab === "FOLLOWED"
                    ? unfollow.mutate(f.maBacSi)
                    : navigate(`/app/doctors/${f.maBacSi}`)
                }
                style={{
                  position: "absolute",
                  top: "20px",
              ...
              >
                <div style={{ position: "relative", flexShrink: 0 }}>
                  ...
                  >
                    <img
                      src={`https://i.pravatar.cc/150?u=${f.maBacSi}`}
                      alt="avatar"
                      style={{
                        width: "100%",
                        height: "100%",
